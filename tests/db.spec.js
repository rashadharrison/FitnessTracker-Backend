	...
	describe('Routine Activities', () => {
		...
		describe('addActivityToRoutine({ routineId, activityId, count, duration })', () => {
			it('creates a new routine_activity, and return it', async () => {
				...
				expect(routineActivityToCreateAndUpdate.activityId).toBe(
					routineActivityData.activityId
				);
				expect(routineActivityToCreateAndUpdate.count).toBe(
					routineActivityData.count
				);
				expect(routineActivityToCreateAndUpdate.duration).toBe(
